...
public class Constants {
	...
	public static String USER_NAME = "khamassi"; // votre nom d'utilisateur : XXX
	public static String PASS_WORD = "yAMZj2=A"; // votre mot de passe . XXX
	
	
	public static String HOST = "srv-px5.insa-toulouse.fr";  // XXX
	...
	public static String CT_BASE_ID = "21";	 // � modifier (cf. sujet de tp) XXX
